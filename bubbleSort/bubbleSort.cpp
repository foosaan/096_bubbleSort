...
int main() {
	input();			//memenggil prosedur input()
	unsorted();			//memenggil prosedur unsorted()
	bubbleSortArray();	//memenggil prosedur bubblesortarray()
	display();			//memenggil prosedur procedur display()
	return 0;			
}